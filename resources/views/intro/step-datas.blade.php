    ...
    <div class="space-y-4 text-left">
        <div>
            ...
            <input type="date" x-model="form.ano_letivo_inicio" @input="error = ''" 
                   class="w-full rounded-xl border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-black/20 dark:text-white py-3 px-4 focus:ring-blue-500 focus:border-blue-500">
        </div>
