<div class="mb-6">
    ...
    <div class="space-y-4 text-left">
        <div>
            ...
            <select x-model="form.estado" @change="error = ''" class="w-full rounded-xl border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-black/20 dark:text-white py-3 px-4 focus:ring-blue-500 focus:border-blue-500">
...
<div class="flex gap-3 mt-6">
    <button type="button" @click="prevStep()" class="w-1/3 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 font-bold text-lg py-4 rounded-2xl transition active:scale-95">
        Voltar
    </button>

    <button type="button" @click="nextStep()" class="w-2/3 bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg py-4 rounded-2xl shadow-xl shadow-blue-600/20 transition active:scale-95">
        Próximo
    </button>
</div>