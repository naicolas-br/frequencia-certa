...
<div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] sm:hidden pb-safe">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
        ...
        {{-- TOUR: GRADE (MOBILE) --}}
        <a id="tour-grade-mobile" href="{{ route('grade.geral') }}" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group transition-colors">
        ...
        <div class="flex items-center justify-center">
            <a id="tour-add-mobile" href="{{ route('disciplinas.criar') }}" class="inline-flex items-center justify-center w-12 h-12 font-medium bg-blue-600 rounded-full hover:bg-blue-700 shadow-lg shadow-blue-500/40 transform active:scale-95 transition-all -translate-y-4 border-4 border-white dark:border-gray-900">
        ...
        {{-- PERFIL --}}
        <a id="tour-profile-mobile" href="{{ route('profile.edit') }}" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group transition-colors">
