    ...
    <div class="py-6 pb-24" x-data="{ diaAtivo: {{ date('N') > 6 ? 1 : date('N') }} }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        @else
                            <div class="flex flex-col items-center justify-center py-20 text-center bg-white/30 dark:bg-black/10 rounded-[3rem] backdrop-blur-sm border border-dashed border-gray-300/50 dark:border-gray-700/50">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 max-w-[200px]">
                                    Adicione matérias para começar a montar sua grade.
                                </p>
                            </div>
                        @endif
                    </div>
            ...
            @if($totalAulasSemana === 0)
                <div class="hidden md:flex flex-col items-center justify-center py-32 text-center">
                    ...
                    <p class="text-gray-500 mt-2 max-w-md">
                        Sua semana está livre. Adicione matérias para começar a montar sua grade.
                    </p>
                </div>
            @else
